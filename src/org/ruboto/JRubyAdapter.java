...
public class JRubyAdapter {
    ...
    private static String ROOT="/data/ruby";
    ...
    public static synchronized boolean setUpJRuby(Context appContext, PrintStream out) {
        if (!initialized) {
            ...
            System.setProperty("jruby.class.cache.path", ROOT + "/cache");
            ...
            try {
                ...
                String defaultCurrentDir = ROOT + "/scripts";
                ...
                addLoadPath(scriptsDirName(appContext));
    	          put("$package_name", "org.ruboto.core");
